Devise.setup do |config|
  ...
  config.case_insensitive_keys = [:email]  #patrz saml_session_controller linia 73
...
# ==> Configuration for :saml_authenticatable
  ...
  config.saml_configure do |settings|
    ...
    # ??? chyba nadpisuje konfiguracjÄ™ w WSO2IS, gdyĹĽ wystarczy prawidĹ‚owa para parametrĂłw:
    # settings.idp_cert_fingerprint oraz settings.idp_cert_fingerprint_algorithm i dziaĹ‚a.
